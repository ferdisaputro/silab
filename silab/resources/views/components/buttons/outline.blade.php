@php
   $colors = [
      ...
      'yellow' => 'text-yellow-400 border-yellow-400 hover:text-white hover:bg-yellow-500 focus:ring-yellow-300 dark:border-yellow-300 dark:text-yellow-300 dark:hover:bg-yellow-400 dark:focus:ring-yellow-900',
...
<button type="button" class="font-semibold rounded-lg px-5 py-2.5 text-center me-2 mb-2 border focus:ring-4 focus:outline-none {{ $colors["$color"] }}">
