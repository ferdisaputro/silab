            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="overflow-hidden flex-grow-1 ms-3">
                        <p class="mb-3 text-uppercase fw-medium text-muted text-truncate">
                            {{$jb->jenis_barang}}
                        </p>
                        <div class="mb-3 d-flex align-items-center">
                            <h4 class="mb-0 fs-4 flex-grow-1"><span class="counter-value" data-target="{{$jb->barang_data_count}}">0</span></h4>
                            <span class="badge badge-soft-danger fs-12">
                                <i class="align-middle ri-arrow-right-s-line fs-13 me-1"></i>
                                {{$jb->barangData->sum('qty')}}
                            </span>
                        </div>
                        <p class="mb-0 text-muted text-truncate">{{-- Projects this month --}}</p>
                    </div>
                </div>
            </div><!-- end card body -->
        </div>
...
<div class="card tableBarangElement wow fadeInLeft" id="tableCard" style="display: none;">
    <div class="card-header align-items-center d-flex">
        <h4 class="mb-0 card-title flex-grow-1 tableBarangTitle"></h4>
            <button id="BtnAddMinggu" class="float-left btn btn-primary waves-effect waves-light" type="button">
    ...
    <div class="card-body">
        <div class="live-preview">
            <div class="table-responsive">
                <table id="tableBarang" class="table mb-0 table-nowrap" width="100%">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="overflow-hidden flex-grow-1 ms-3">
                        ...
                        <div class="mb-3 d-flex align-items-center">
                            <h4 class="mb-0 fs-4 flex-grow-1"><span class="counter-value" data-target="{{$cMonthly}}">0</span></h4>
                            <span class="badge badge-soft-danger fs-12">
                                <i class="align-middle ri-arrow-right-s-line fs-13 me-1"></i>
