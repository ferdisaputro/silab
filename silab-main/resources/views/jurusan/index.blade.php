        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <div class="card formElement" style="display: none;" id="formContainer">
                <div class="card-header align-items-center d-flex">
                    <h4 class="mb-0 card-title flex-grow-1">Tambah Data Jurusan</h4>
                    ...
                    <div class="live-preview">
                        <div class="row g-3">
                            <form action="" class="form-horizontal" id="frmJurusan" method="post" enctype="multipart/form-data" data-parsley-validate="">
                                ...
                                <input type="hidden" name="tr_kajur_id">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-xxl-4 col-md-4">
                                        <div>
                                            <label for="kodejurusan" class="text-right form-label">Kode Jurusan</label>
                                    ...
                                    <div class="col-xxl-4 col-md-4">
                                        <div>
                                            <label for="SelectKaJur" class="text-right form-label">Pilih Ka. Jurusan</label></br>
                                            <select class="form-control" style="font-size: 15px;" name="tm_staff_id" id="SelectKaJur">
                                                <option></option>
                                    ...
                                    <div class="gap-3 col-md-12 row button-items justify-content-center" style="margin-top: 10px;">
            ...
            <div class="card tableElement wow fadeInLeft" id="tableCard" style="display: @if ($errors->any()) none @else block @endif">
                <div class="card-header align-items-center d-flex">
                    <h4 class="mb-0 card-title flex-grow-1">Tabel Data Jurusan</h4>
                    @can('jurusan-create')
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            <table id="tableUser" class="table mb-0 align-middle table-nowrap">
            ...
            <div class="card formElementProdi" style="display: none;" id="formContainerProdi">
                <div class="card-header align-items-center d-flex">
                    <h4 class="mb-0 card-title flex-grow-1">Tambah Data Program Studi</h4>
                    <div class="flex-shrink-0">
                       {{--  Left Content --}}
                    </div>
                </div><!-- end card header -->
                    ...
                    <form action="" class="form-horizontal" id="frmProdi" method="post" enctype="multipart/form-data" data-parsley-validate="">
                        <div class="row d-flex justify-content-center">
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    <label for="txtProdiKode" class="text-right col-label">Kode Program Studi</label>
                            ...
                            <div class="col-xxl-4 col-md-6">
                                <div>
                                    <label for="txtProgramStudiTitle" class="text-right col-label">Program Studi</label>
                            ...
                            <div class="col-xxl-4 col-md-4">
                                        <div>
                                            <label for="SelectKaprodi" class="text-right form-label">Pilih Ka. Program Studi</label></br>
                                            <select class="form-control" style="font-size: 15px;" name="SelectKaprodi" id="SelectKaprodi">
                                                <option></option>
                                                @foreach($data['dosen'] as $v)
                                                    <option value="{{$v->id}}">{{$v->nama}}</option>
                                                @endforeach
            ...
            <div class="card tableElementProdi col-md-12 col-lg-12 col-sm-12" id="tableProdi" style="display: flex; flex-direction: column; width: 100%;">
                <div class="card-header align-items-center d-flex">
                    <h4 class="mb-0 card-title flex-grow-1 header-title-prodi"></h4>
                    @can('prodi-create')
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            <table id="tblAllInOneProdi" class="table mb-0 align-middle table-nowrap" width="100%" cellspacing="">
                                <thead class="table-light">
                                    <tr>
