...
{{-- x-data="ubahPegawai" x-on:submit.prevent="ubah" --}}
    ...
    <form action="">
        ...
        <x-forms.select name="ketua_jurusan" label="Pilih Ketua Jurusan" default="{{ $kajur?? '' }}" :options="['kajur-1' => 'kajur-1-value', 'kajur-2' => 'kajur-2-value', 'kajur-3' => 'kajur-3-value', 'kajur-3' => 'kajur-4-value']" />
