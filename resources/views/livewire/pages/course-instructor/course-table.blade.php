            ...
            @for ($i = 0; $i < 50; $i++)
                <tr>
                    ...
                    <td class="text-center">
                        {{-- this button is dispatching a function from pages/CourseInstructor/Index --}}
                        <x-badges.outline wire:click="dispatch('setCourse', {course: {{ $i }}}); selectCourseState = false" title="Pilih" class="px-2.5 py-1.5" color="blue">Pilih Matakuliah</x-badges.outline>
                    </td>
                </tr>
            @endfor
        </tbody>
