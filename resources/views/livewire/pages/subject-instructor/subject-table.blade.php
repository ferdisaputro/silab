            ...
            @for ($i = 0; $i < 50; $i++)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <x-badges.outline wire:click="dispatch('setSubject', {subject: {{ $i }}}); selectSubjectState = false" title="Pilih" class="px-2.5 py-1.5" color="blue">Pilih Matakuliah</x-badges.outline>
                    </td>
                </tr>
            @endfor
        </tbody>
