<x-container>
    <div class="p-5 space-y-6 bg-white rounded-lg">
        <div class="flex items-center justify-between">
            <h3 class="text-xl text-semibold">Tabel Data Pegawai</h3>
            <a href="{{ route('pegawai.tambah') }}">
                <x-buttons.fill color="teal">Tambah Pegawai</x-buttons.fill>
            </a>
        </div>
