    ...
    <div class="p-5 space-y-10">
        ...
        <div class="space-y-5">
            ...
            <div class="grid grid-cols-1 gap-4 px-5 md:grid-cols-2">
                ...
                <div class="space-y-4">
                    <x-forms.input value="{{ date('d/m/Y', strtotime($this->equipmentLoan->returning_date)) }}" disabled class="flex-1 md:min-w-[20rem]" name="tanggal_pengembalian" label="Tanggal Pengembalian" type="datepicker" />
