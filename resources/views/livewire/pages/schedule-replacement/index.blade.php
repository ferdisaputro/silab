            ...
            <x-tables.datatable>
                <thead>
                    <tr>
                        ...
                        <th>Jadwal Asli <i class="fa-solid fa-sort ms-2"></i></th>
                        <th>Jadwal Ganti <i class="fa-solid fa-sort ms-2"></i></th>
                    ...
                    @for ($i = 0; $i < 50; $i++)
                        ...
                        <tr>
                            ...
                            <td class="flex flex-wrap justify-center gap-2 text-center">
                                ...
                                <a href="{{ route('schedule-replacement.edit', ['id' => Crypt::encrypt($i)]) }}" wire:navigate>
