...
@php
   $colors = [
      'blue' => 'text-blue-400 border-blue-400 hover:text-white hover:bg-blue-500 focus:ring-blue-300 dark:border-blue-500 dark:text-blue-500 dark:hover:bg-blue-500 dark:focus:ring-blue-500',
      ...
      'gray' => 'text-gray-400 border-gray-400 hover:text-white hover:bg-gray-500 focus:ring-gray-300 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-600 dark:focus:ring-gray-800',
      ...
      'yellow' => 'text-yellow-400 border-yellow-400 hover:text-white hover:bg-yellow-400 focus:ring-yellow-400 dark:border-yellow-400 dark:text-yellow-500 dark:hover:bg-yellow-500 dark:focus:ring-yellow-900',
...
<button type="{{ $type }}" {{ $attributes->merge(["class" => "font-semibold rounded-lg text-center border focus:ring-4 focus:outline-none $colors[$color]"]) }}>
